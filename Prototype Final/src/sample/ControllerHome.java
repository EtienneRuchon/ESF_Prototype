...
public class ControllerHome implements  Initializable  {
    ...
    public void handleButtonHome(ActionEvent actionEvent) {
    }
    ...
    public void TestExitCouleurContact(MouseEvent mouseEvent) {
        CouleurContact.setStyle("-fx-background-color:  #ffffffff; -fx-border-color: #3b649a; -fx-font-family: 'Letters for Learners'; -fx-font-size : 24;");
        CouleurContact.setPrefHeight(75.0);
        CouleurContact.setPrefWidth(275);
    }
    ...
    public void handleJoinMeeting(MouseEvent mouseEvent) {
    }

    public void handleFolder(MouseEvent mouseEvent) {
    }

    public void handleSchareScreen(MouseEvent mouseEvent) {
    }

    public void handleCalendar(MouseEvent mouseEvent) {
    }

    public void handleSupport(MouseEvent mouseEvent) {
    }
}
